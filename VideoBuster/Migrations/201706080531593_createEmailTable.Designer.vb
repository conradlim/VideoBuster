...
Namespace Migrations
    ...
    Public NotInheritable Partial Class createEmailTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(createEmailTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706080531593_createEmailTable"
            End Get
        End Property
