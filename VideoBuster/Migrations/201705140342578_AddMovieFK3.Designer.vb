...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddMovieFK3
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddMovieFK3))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705140342578_AddMovieFK3"
            End Get
        End Property
