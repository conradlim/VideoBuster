...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DropPhoneNumberCol
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DropPhoneNumberCol))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706031642170_DropPhoneNumberCol"
            End Get
        End Property
