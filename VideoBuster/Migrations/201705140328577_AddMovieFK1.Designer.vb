...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddMovieFK1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddMovieFK1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705140328577_AddMovieFK1"
            End Get
        End Property
