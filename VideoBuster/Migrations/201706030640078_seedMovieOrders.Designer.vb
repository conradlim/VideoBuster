...
Namespace Migrations
    ...
    Public NotInheritable Partial Class seedMovieOrders
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(seedMovieOrders))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706030640078_seedMovieOrders"
            End Get
        End Property
