...
Namespace Migrations
    ...
    Public NotInheritable Partial Class updateZipAnnotation
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(updateZipAnnotation))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706040911064_updateZipAnnotation"
            End Get
        End Property
