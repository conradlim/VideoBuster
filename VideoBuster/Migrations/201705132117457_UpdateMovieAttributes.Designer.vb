...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UpdateMovieAttributes
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateMovieAttributes))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705132117457_UpdateMovieAttributes"
            End Get
        End Property
