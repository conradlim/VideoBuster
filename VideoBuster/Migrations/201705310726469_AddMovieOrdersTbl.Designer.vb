...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddMovieOrdersTbl
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddMovieOrdersTbl))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705310726469_AddMovieOrdersTbl"
            End Get
        End Property
