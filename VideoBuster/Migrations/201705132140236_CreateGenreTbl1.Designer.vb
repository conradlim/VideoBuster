...
Namespace Migrations
    ...
    Public NotInheritable Partial Class CreateGenreTbl1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CreateGenreTbl1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705132140236_CreateGenreTbl1"
            End Get
        End Property
