...
Namespace Migrations
    ...
    Public NotInheritable Partial Class initialmodel1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(initialmodel1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705090450264_initialmodel1"
            End Get
        End Property
