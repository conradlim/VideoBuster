...
Namespace Migrations
    ...
    Public NotInheritable Partial Class removeMovieData
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(removeMovieData))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705140325171_removeMovieData"
            End Get
        End Property
