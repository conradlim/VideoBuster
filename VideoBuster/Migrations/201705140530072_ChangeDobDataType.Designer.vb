...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ChangeDobDataType
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ChangeDobDataType))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705140530072_ChangeDobDataType"
            End Get
        End Property
