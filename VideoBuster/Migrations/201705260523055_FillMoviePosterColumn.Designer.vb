...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FillMoviePosterColumn
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FillMoviePosterColumn))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201705260523055_FillMoviePosterColumn"
            End Get
        End Property
